# Scam Reporting Portal - Task List

## Planning & Requirements
- [ ] Define Product Requirements Document (PRD) <!-- id: 0 -->
    - [ ] Define Tech Stack <!-- id: 1 -->
    - [ ] Define Color Palette & Design System <!-- id: 2 -->
    - [ ] Define Database Schema <!-- id: 3 -->
